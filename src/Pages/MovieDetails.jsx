...
// console.log(info)
  ...
  return info?(
    ...
    <div className='w-full text-white ml-7 '>
      <div>
        <h1 className=' text-7xl -mt-2  font-bold'>{info.details.name || info.details.title || info.details.original_name || info.details.original_title} <small className='text-xl -ml-3 opacity-50'>({info.details.release_date.split("-")[0]})</small> </h1>
