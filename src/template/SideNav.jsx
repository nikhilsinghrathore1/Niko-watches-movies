...
const SideNav = () => {
  ...
  return (
    <div className='w-[20%] text-white px-6 pt-7 h-screen border-r-[2px] border-zinc-400'>
               ...
               <div className='mt-14'>
                              ...
                              <div className='px-1 mt-5 border-b-[2px] border-zinc-400/40 pb-2'>
                                             ...
                                             <div className='flex  opacity-70 text-[17px] p-4 hover:bg-[#6556cd] hover:opacity-100 hover:text-white duration-150 rounded-[5px] gap-[5px] items-center'>
