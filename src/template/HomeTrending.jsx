...
const HomeTrending = ({data ,fn}) => {
  ...
  return(
    <div className='w-full relative px-5 pt-1 h-[70vh]'>
            ...
            <div className='flex w-full h-full text-white overflow-x-auto gap-12 pt-5 pb-10 flex-wrap'>
               {data.map((e,i)=>(
           
               <div onClick={()=>navigate(`/${e.media_type}/${e.id}`)} className='w-[20%] flex-shrink-0 h-[63%] rounded overflow-hidden bg-black/50'>
